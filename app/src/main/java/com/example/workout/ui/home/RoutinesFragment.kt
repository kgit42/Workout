...
class RoutinesFragment : Fragment() {
    ...
    //private val bundleRecyclerLayout = "classname.recycler.layout"
    ...
    override fun onCreateView(
        ...
        homeViewModel.getAllRoutines()
            .observe(viewLifecycleOwner) { routines ->
                ...
                //Log.v("hhh", savedRecyclerLayoutState.toString())
                //(recyclerView.layoutManager as LinearLayoutManager).onRestoreInstanceState(savedRecyclerLayoutState);
            }
...
override fun onResume() {
    ...
    /*
//für das Wiederherstellen der Scroll-Position wenn man zurück geht, von der Detail-Ansicht aus kommend
override fun onViewStateRestored(savedInstanceState: Bundle?) {
    super.onViewStateRestored(savedInstanceState)
    if (savedInstanceState != null) {
        savedRecyclerLayoutState =
            savedInstanceState.getParcelable<Parcelable>(bundleRecyclerLayout)
        recyclerView.layoutManager?.onRestoreInstanceState(savedRecyclerLayoutState)
    }
}

override fun onSaveInstanceState(outState: Bundle) {
    Log.v("hhh", outState.toString())
    super.onSaveInstanceState(outState)
    outState.putParcelable(
        bundleRecyclerLayout,
